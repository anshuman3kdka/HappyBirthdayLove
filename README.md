...
*   **Auto-Orienting Archive Film Frames:** The Archive reel now reads each film-strip image as it loads, keeps landscape memories wide, and reshapes portrait memories into upright frames with a subtle turning motion between slides. If the photos are replaced later, the reel recalculates their orientation automatically instead of needing a code edit.
...
*   **[v1.37.0]** - Archive Auto-Orientation Reel: Taught the film strip to inspect each loaded photograph's natural dimensions, hold landscape frames steady, and turn portrait memories into vertical cinematic frames with a springing reel motion so future photo swaps still feel personally composed.

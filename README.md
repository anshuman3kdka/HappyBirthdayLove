...
*   **Same-Address Scene Navigation:** The top tabs are now in-place scene switches, not route links. Clicking Journal, Archive, Projection, or Sky changes the visible room, crossfades the soundtrack, and triggers the cosmic background transition while the browser stays on the same URL.

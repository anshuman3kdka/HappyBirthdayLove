...
8. **Fresh Premiere on Every Reload:** A browser refresh is treated like raising the curtain again, not resuming a half-watched scene. The observatory intentionally resets to the opening route and envelope so the birthday experience always starts from the beginning.

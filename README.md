...
*   **Framed Memories:** Cinematic layout cards and journal entries to recount milestones with grace and fluid `framer-motion` animations. Journal memories now carry their own misted photographic backdrops, so each written moment can glow through the haze like a recovered frame from the birthday film reel.
